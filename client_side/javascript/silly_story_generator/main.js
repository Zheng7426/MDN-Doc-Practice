...
const insertX = ["Willy Dog", "Big Trouble", "Louis XVI"];
const insertY = ["Jingoism", "Punkah", "the Black Horse"];
const insertZ = ["spontaneously combusted", "melted into a puddle on the sidewalk", "turned into a banana and crawled away"];
